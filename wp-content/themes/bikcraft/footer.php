...
<footer>
	<div class="footer">
		<div class="container">
			...
			<div class="grid-4 footer_redes">
				<h3>Redes Sociais</h3>
                <?php
                include (TEMPLATEPATH . "/inc/redes-sociais.php");
                ?>
			</div>
	...
	<div class="copy">
		<div class="container">
			<p class="grid-16"><?php bloginfo('name');?> <?= date("Y");?> - Alguns direitos reservados.</p>
		</div>
	</div>
</footer>

<!-- JavaScript -->
<script src="<?=get_template_directory_uri()?>/js/libs/jquery-1.11.2.min.js"></script>
